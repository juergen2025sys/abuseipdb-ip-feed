...
| Feed | IPs |
|---|---:|
| `firehol_anonymous` ⭐ | 1820543 |
| `firehol_proxies` ⭐ | 1820075 |
| `black_mirror` | 1432413 |
| `bluetack_blacklist` | 738955 |
| `magicteamc_bad_ips` | 625622 |
| `ipsum_master` | 547811 |
...
| `abuseipdb_axllent` | 108779 |
| `netmountains_blocklist` ⭐ | 99362 |
| `data_shield` ⭐ | 97662 |
...
| `abuseipdb_tmiland` | 9985 |
| `subnet_blocklist_new` | 9391 |
| `florent_banned` | 9194 |
| `threatview_high_conf` ⭐ | 8920 |
...
| `blocklist_de_strongips` ⭐ | 305 |
| `crowdsec_ssh` ⭐ | 298 |
| `honeypot_blocklist` | 292 |
| `firehol_cybercrime` ⭐ | 216 |
| `firehol_webclient` ⭐ | 216 |
| `ipsum_level7` ⭐ | 215 |
| `turntuptechnologies_iocs` | 143 |
| `turntuptechnologies_iocs_v2` | 143 |
| `c2_iplist` ⭐ | 127 |
| `kevinmarx` | 70 |
